...
public class OpenOrderDone {
	...
	public OpenOrderDone() {
		...
		FileList.setFinishedOrderFolder();
		
		FileCreateButtons = new FileCreateButtons(FileList.FileList);
		FileCreateButtons.setFinishedOrderFolder();
	...
	public void setSelectedOrderDataAll(int Number) {
		...
		FileFolderM.setFolderList("Avslutade", GetOrder.OrderNr, FileList.FileList);
